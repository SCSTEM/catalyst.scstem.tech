...
// Recharts injects these props into tooltip content at runtime
...
// Recharts injects these props into legend content at runtime
      ...
      {payload.map((item) => {
        ...
        return (
          <div
            key={item.value}
            className={cn(
              "[&>svg]:text-foreground flex items-center gap-1.5 [&>svg]:size-3",
            )}
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                className="size-3 border border-border shrink-0 rounded-xs"
                style={{
